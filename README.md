...
5. Copy `spotify_auto_start.example.ahk` to `spotify_auto_start.ahk`, fill in your own paths, then run it with AutoHotkey. This filename is gitignored, so your personal copy with your paths in it never gets committed.
